...
```{r}
x1 <- train_qda_dis[train_qda_dis$word_freq_make == 0,]
x2 <- train_qda_dis[train_qda_dis$word_freq_address == 0,]
x3 <- train_qda_dis[train_qda_dis$word_freq_all == 0,]
x4 <- train_qda_dis[train_qda_dis$word_freq_3d == 0,]
x5 <- train_qda_dis[train_qda_dis$capital_run_length_longest == 0,]
qr(x1)$rank
qr(x2)$rank
qr(x3)$rank
qr(x4)$rank
